      ...
      <div className="mx-auto max-w-6xl">
        <div className="mb-8 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm font-semibold text-[#FFF6F0]">@ventiate</span>
          </div>
          <Link href="https://instagram.com/ventiate" target="_blank" rel="noopener noreferrer"
        ...
        <div className="grid grid-cols-3 gap-1 md:grid-cols-6">
          {POSTS.map((post, i) => (
            <Link key={i} href="https://instagram.com/ventiate" target="_blank" rel="noopener noreferrer"
